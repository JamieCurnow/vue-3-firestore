...
export declare type OptionsCollGet<T, M> = OptionsBase<T, M> & OptionsColl<T, M> & OptionsGet;
export declare type OptionsDocWatch<T, M> = OptionsBase<T, M> & OptionsDoc<T, M> & OptionsGet;
export declare type OptionsDocGet<T, M> = OptionsBase<T, M> & OptionsDoc<T, M> & OptionsWatch;
export declare type Options<T, M = T> = OptionsCollWatch<T, M> | OptionsCollGet<T, M> | OptionsDocGet<T, M> | OptionsDocWatch<T, M>;
