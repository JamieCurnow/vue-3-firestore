...
export declare type ReturnCollGet<T, M> = ReturnColl<T, M> & ReturnGetColl<T, M>;
export declare type ReturnDocWatch<T, M> = ReturnDoc<T, M> & ReturnWatch;
export declare type ReturnDocGet<T, M> = ReturnDoc<T, M> & ReturnGetDoc<T, M>;
export declare type ReturnTypes<T, M> = ReturnCollWatch<T, M> | ReturnCollGet<T, M> | ReturnDocWatch<T, M> | ReturnDocGet<T, M>;
